...
言語は Ruby です。Ruby でのテスト駆動開発の詳細に関しては[こちらの記事](https://k2works.github.io/2020/04/16/1587009564/)をご参照ください。下のボタンをクリックするとブラウザ開発環境が起動するのでお手軽に開発を始めることが出来ます。

[Open in Gitpod](https://gitpod.io/#https://github.com/k2works/tdd_itddd/tree/ruby^)
