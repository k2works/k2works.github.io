...
image::../../images/asciidoc/tdd_env/pkg-003.png[]
image::../../images/asciidoc/tdd_env/pkg-004.png[]
image::../../images/asciidoc/tdd_env/pkg-005.png[]
image::../../images/asciidoc/tdd_env/pkg-006.png[]
...
choco install git
```
image::../../images/asciidoc/tdd_env/git-002.png[]
...
image::../../images/asciidoc/tdd_env/terminal-003.png[]
...
image::../../images/asciidoc/tdd_env/wsl-004.png[]
...
image::../../images/asciidoc/tdd_env/wsl-008-1.png[]

画面左下のスタートメニューから `Ubuntu` を選択します。

image::../../images/asciidoc/tdd_env/wsl-008-2.png[]

セットアップが始まるのでユーザーIDとパスワードを設定してください。

image::../../images/asciidoc/tdd_env/wsl-009.png[]
image::../../images/asciidoc/tdd_env/wsl-010.png[]
...
image::../../images/asciidoc/tdd_env/sync-008.png[]
...
image::../../images/asciidoc/tdd_env/hello-034.png[]
